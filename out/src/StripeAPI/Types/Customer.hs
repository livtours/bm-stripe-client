...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerDiscount'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerDiscount'NonNullable" (\obj -> ((((((((((GHC.Base.pure CustomerDiscount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "checkout_session")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice_item")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "start")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "subscription"))
...
data CustomerSources'Data'Object' =
  ...
  | CustomerSources'Data'Object'EnumAlipayAccount -- ^ Represents the JSON value @"alipay_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerSources'Data'Object'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "alipay_account" -> CustomerSources'Data'Object'EnumAlipayAccount
...
data CustomerSources'Data'Recipient'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerSources'Data'Recipient'NonNullableVariants
    where toJSON (CustomerSources'Data'Recipient'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (CustomerSources'Data'Recipient'NonNullableRecipient a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON CustomerSources'Data'Recipient'NonNullableVariants
    where parseJSON val = case (CustomerSources'Data'Recipient'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((CustomerSources'Data'Recipient'NonNullableRecipient Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
data CustomerSources'Data'Transactions' = CustomerSources'Data'Transactions' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerSources'Data'Transactions'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= customerSources'Data'Transactions'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= customerSources'Data'Transactions'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= customerSources'Data'Transactions'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerSources'Data'Transactions'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerSources'Data'Transactions'" (\obj -> ((GHC.Base.pure CustomerSources'Data'Transactions' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'CustomerSources'Data'Transactions'' with all required fields.
mkCustomerSources'Data'Transactions' :: [BitcoinTransaction] -- ^ 'customerSources'Data'Transactions'Data'
  -> GHC.Types.Bool -- ^ 'customerSources'Data'Transactions'HasMore'
  -> Data.Text.Internal.Text -- ^ 'customerSources'Data'Transactions'Url'
  -> CustomerSources'Data'Transactions'
mkCustomerSources'Data'Transactions' customerSources'Data'Transactions'Data customerSources'Data'Transactions'HasMore customerSources'Data'Transactions'Url = CustomerSources'Data'Transactions'{customerSources'Data'Transactions'Data = customerSources'Data'Transactions'Data,
