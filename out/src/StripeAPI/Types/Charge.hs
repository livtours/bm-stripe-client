...
mkCharge :: GHC.Types.Int -- ^ 'chargeAmount'
  ...
  -> ChargeStatus' -- ^ 'chargeStatus'
  -> Charge
mkCharge chargeAmount chargeAmountCaptured chargeAmountRefunded chargeBillingDetails chargeCaptured chargeCreated chargeCurrency chargeDisputed chargeId chargeLivemode chargeMetadata chargePaid chargeRefunded chargeRefunds chargeStatus = Charge{chargeAmount = chargeAmount,
...
data ChargeInvoice'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ChargeInvoice'NonNullableVariants
    where toJSON (ChargeInvoice'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (ChargeInvoice'NonNullableInvoice a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON ChargeInvoice'NonNullableVariants
    where parseJSON val = case (ChargeInvoice'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ChargeInvoice'NonNullableInvoice Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
mkChargeOutcome'NonNullable = ChargeOutcome'NonNullable{chargeOutcome'NonNullableNetworkStatus = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON ChargeRefunds'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= chargeRefunds'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= chargeRefunds'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= chargeRefunds'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= chargeRefunds'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= chargeRefunds'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= chargeRefunds'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON ChargeRefunds'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "ChargeRefunds'" (\obj -> ((GHC.Base.pure ChargeRefunds' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'ChargeRefunds'' with all required fields.
mkChargeRefunds' :: [Refund] -- ^ 'chargeRefunds'Data'
  -> GHC.Types.Bool -- ^ 'chargeRefunds'HasMore'
  -> Data.Text.Internal.Text -- ^ 'chargeRefunds'Url'
  -> ChargeRefunds'
mkChargeRefunds' chargeRefunds'Data chargeRefunds'HasMore chargeRefunds'Url = ChargeRefunds'{chargeRefunds'Data = chargeRefunds'Data,
